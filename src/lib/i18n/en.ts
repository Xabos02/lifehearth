...
export const EN: Record<string, string> = {
  ...
  'На связи': 'Connected',
  'Отклонить': 'Decline',
  // «Микрофон» — подпись кнопки mute на звонке. «Включить» — омоним: в словаре
  // частый смысл (уведомления в настройках, семье и «Фокусе»), «Unmute» под
  // выключенным микрофоном — ветка языка в CallOverlay.
  'Включить': 'Turn on',
  'Микрофон': 'Mute',
  'Динамик': 'Speaker',
  'К уху': 'Earpiece',
  ...
  'Сбросить': 'Reset',
  'Старт': 'Start',
  'Завершить круг': 'End round',
  'Пропустить перерыв': 'Skip break',
  'Выбрать задачу': 'Choose a task',
  'Фоновый шум': 'Background noise',
  'Сигнал в конце круга': 'End-of-round chime',
  'Двойной': 'Double',
  'Гонг': 'Gong',
  'Нажатие на вариант — проиграть. В свёрнутом приложении звучит стандартный сигнал уведомления.':
    'Tap an option to hear it. When the app is in the background, the standard notification sound plays.',
  'Кругов до него': 'Rounds before it',
  'Круг {n} из {total}': 'Round {n} of {total}',
  'Уведомления выключены — о конце круга в свёрнутом приложении не узнать.':
    'Notifications are off — you won\'t know the round ended while the app is in the background.',
  'Шаблоны': 'Templates',
  'Шаблон': 'Template',
  'помодоро сегодня': 'pomodoros today',
  'кругов сегодня': 'rounds today',
  ...
  'Например, 20': 'e.g. 20',
  '+{n} нед. к сроку': '+{n} wk past deadline',
  ', всего {n}': ', {n} in total',
  '{a} из {b}': '{a} of {b}',
  '{time} на этой неделе': '{time} this week',
  'Движение по графику': 'Against the plan',
  'Занятия': 'Sessions',
  ...
  'Получится частей: {n}': 'Parts: {n}',
  'Разбейте материал на части — главы, темы, дисциплины. Прогресс пойдёт по ним.': 'Break it into parts — chapters, topics, courses. Progress will follow them.',
  'Составить план': 'Build a plan',
  'Сохранить план': 'Save plan',
  'Строка с # — раздел плана. Число после тире — сколько это займёт; можно не ставить.': 'A line starting with # is a section. A number after a dash is the estimate; it is optional.',
  'У материала нет срока. Поставьте его в карточке — появится график и темп.': 'This item has no deadline. Set one in the card to get the pace and the chart.',
  'в срок': 'on time',
  'за 28 дней': 'over 28 days',
  'нет записей': 'no sessions yet',
  'нужно в неделю': 'needed a week',
  'осталось': 'left',
  'осталось {n} дн.': '{n} d left',
  'план': 'plan',
  'пока пусто': 'nothing yet',
  'появится после записей': 'appears after sessions',
  'появится, когда пойдёт прогресс': 'appears once progress starts',
  'пусто': 'empty',
  'срок {date}': 'due {date}',
  'твой темп': 'your pace',
  'факт': 'actual',
  'финиш': 'finish',
  'Идёшь по графику': 'On track',
  'Без срока': 'No deadline',
  'Отстаёшь на {n}\u00A0{unit}': '{n}\u00A0{unit} behind',
  '{n}\u00A0{unit} в неделю': '{n}\u00A0{unit} a week',
  'Записать занятие': 'Log a session',
  'Занятие': 'Session',
  'просрочено': 'overdue',
  '{n} дн.': '{n} d',
  'стр.': 'pp.',
  'Сколько занимался?': 'How long did you study?',
  'Или своё время, часов': 'Or your own time, hours',
  'Например, 2,5': 'e.g. 2.5',
  'Над чем работал': 'What you worked on',
  'Необязательно': 'Optional',
  'Записать {time}': 'Log {time}',
  'Записать': 'Log',
  'Часы': 'Hours',
  ...
  'Со сроком приложение считает, сколько нужно в неделю, и предупреждает, когда начинаешь отставать.':
    'With a deadline the app works out your weekly pace and warns you when you start falling behind.',
  ...
  'завтра': 'tomorrow',
  'через {n}': 'in {n}',
  'Всё в одном месте': 'All in one place',
  'Задачи, заметки, цели, деньги и семья. Работает без интернета, всё хранится у вас на телефоне.': 'Tasks, notes, goals, money and family. Works offline, everything stays on your phone.',
  'Один экран на день: что сделать, что запланировано, как вы себя чувствуете. Ничего лишнего.': 'One screen for the day: what to do, what is planned, how you feel. Nothing extra.',
  'Запишите и отпустите. Приложение напомнит вовремя — заранее или утром в день задачи.': 'Write it down and let go. The app reminds you on time — in advance or on the morning of the task.',
  'Начните писать — первая строка станет названием. Фото и файлы прикрепляются прямо в заметку.': 'Start typing — the first line becomes the title. Photos and files attach right into the note.',
  'Поставьте цель и отмечайте шаги. Прогресс виден сразу — и по деньгам, и по делам.': 'Set a goal and mark your steps. Progress shows at once — in money and in deeds.',
  'Общий чат, звонки и задачи на всех. Переписка зашифрована — её видят только участники.': 'Shared chat, calls and tasks for everyone. Messages are encrypted — only members can read them.',
  'Ваши данные': 'Your data',
  'Всё хранится на телефоне. Включите синхронизацию — записи появятся на всех устройствах и переживут потерю телефона.': 'Everything is stored on your phone. Turn on sync — your records appear on all devices and survive a lost phone.',
  'Дальше — просто': 'From here it\'s simple',
  'Подсказки появятся сами, когда пригодятся. Ненужные разделы можно спрятать в настройках.': 'Tips appear on their own when useful. Sections you don\'t need can be hidden in settings.',
  ...
  'Переместить ({n})': 'Move ({n})',
  'Удалить ({n})': 'Delete ({n})',
  'Перенесено: {n}': 'Moved: {n}',
  'Удалить {n}? Вернуть можно из Корзины.': 'Delete {n}? You can restore them from Trash.',
  'Удалено: {n}. Вернуть можно из Корзины': 'Deleted: {n}. You can restore them from Trash',
  '{n} — выберите папку.': '{n} — choose a folder.',
  'заметку': 'note',
  'заметки': 'notes',
  'заметок': 'notes',
  ...
  'Удалить файл из задачи?': 'Delete this file from the task?',
  'Убрать файл': 'Remove file',
  'добавится при сохранении': 'added on save',
  ...
  // Ключ восстановления и подключение по нему
  'Ключ восстановления': 'Recovery key',
  'Ключ восстановления LifeHearth': 'LifeHearth recovery key',
  'Этим кодом возвращают все записи, если телефон потерян или заменён.': 'This code brings back all your entries if the phone is lost or replaced.',
  'Второй копии ключа нет ни у кого, включая разработчика: потеряете — восстановить будет нечем.': 'No one else has a copy of this key, the developer included: lose it and there is nothing left to restore from.',
  'Куда вставлять: приложение → Настройки → Синхронизация → «У меня уже есть данные».': 'Where to paste it: the app → Settings → Sync → “I already have data”.',
  'Можно вставить весь этот файл целиком — приложение само найдёт код.': 'You can paste this whole file — the app will find the code itself.',
  'Сохранён: {date}': 'Saved: {date}',
  'Этим ключом возвращают все записи, если телефон потерян или заменён. Второй копии нет ни у кого, включая разработчика.': 'This key brings back all your entries if the phone is lost or replaced. No one else has a copy, the developer included.',
  'готовим…': 'preparing…',
  'Скопировать ключ': 'Copy the key',
  'Ключ восстановления — скопируйте вручную:': 'Recovery key — copy it manually:',
  'Ключ ещё готовится, повторите через мгновение': 'The key is still being prepared, try again in a moment',
  'Не удалось поделиться файлом. Он сохранён — найдите его в «Файлах»': 'Could not share the file. It is saved — look for it in Files',
  'Файл сохранён. Теперь вставьте его содержимое ниже — проверим, что он рабочий': 'File saved. Now paste its contents below — let us check that it works',
  'Храните файл НЕ на этом телефоне: облако, второе устройство, распечатка. Кто получит файл — получит все ваши записи.': 'Keep the file somewhere OTHER than this phone: cloud storage, a second device, a printout. Whoever gets the file gets all your entries.',
  'Ключ сохранён и проверен': 'Key saved and verified',
  'Проверьте сохранённое': 'Check what you saved',
  'Откройте сохранённый файл и вставьте сюда — целиком, как есть. Так вы узнаете, что он рабочий, пока телефон ещё при вас.': 'Open the saved file and paste it here, whole and as is. That way you learn it works while the phone is still with you.',
  'Вставьте содержимое файла': 'Paste the file contents',
  'Это не тот ключ. Вставьте содержимое сохранённого файла целиком.': 'That is not the right key. Paste the whole contents of the saved file.',
  'Проверить': 'Check',
  'Ключ восстановления не сохранён. Без него записи из облака не вернуть ничем. Всё равно закрыть?': 'The recovery key is not saved. Without it nothing can bring your cloud entries back. Close anyway?',
  'Ключ восстановления не сохранён. Без него записи из облака не вернуть — сохраните файл сейчас.': 'The recovery key is not saved. Without it your cloud entries cannot be brought back — save the file now.',
  'Ключ восстановления · сохранён': 'Recovery key · saved',
  'Сохранить ключ восстановления': 'Save the recovery key',
  'Включить синхронизацию': 'Turn on sync',
  'У меня уже есть данные — подключить по ключу': 'I already have data — connect with a key',
  'Подключить по ключу': 'Connect with a key',
  'Вставьте ключ восстановления или код с другого устройства': 'Paste a recovery key or a code from another device',
  'Отключить синхронизацию на этом устройстве? Записи на телефоне останутся. Ключ с телефона будет стёрт — вернуть облако можно будет только сохранённым файлом ключа.': 'Turn sync off on this device? Entries on the phone stay. The key will be wiped from this phone — only a saved key file will bring the cloud back.',
  'Отключить синхронизацию? Ключ восстановления НЕ сохранён, а отключение стирает его с телефона: облачные записи после этого не вернуть ничем. Сначала сохраните ключ.': 'Turn sync off? The recovery key is NOT saved, and turning sync off wipes it from this phone: after that nothing can bring the cloud entries back. Save the key first.',
  'Этот ID должен совпадать на всех ваших устройствах: разный ID — разные аккаунты, и данные между ними не ходят. Хранить ID не нужно — он лежит внутри ключа восстановления.': 'This ID must match on all your devices: a different ID means a different account, and data does not travel between them. You do not need to keep the ID — it lives inside the recovery key.',
  'Аккаунта с этим ключом на сервере нет. Ключ верный по виду, но данных под ним не найдено.': 'There is no account with this key on the server. The key looks valid, but no data was found under it.',
  ...
  // Раздел «Здоровье» (задача 14)
  'Тренировки и замеры': 'Workouts and measurements',
  'Спорт': 'Sport',
  'Замеры': 'Measurements',
  '+ Тренировка': '+ Workout',
  '+ замер': '+ entry',
  ', тренировок: {n}': ', workouts: {n}',
  'Apple Health веб-приложению закрыт, а Strava пускает к данным только по платной подписке. Зато файл выгрузки есть у всех: подойдёт activities.csv из Strava, выгрузка Garmin или своя таблица с датой, видом и минутами.': 'Apple Health is closed to web apps, and Strava only shares data with a paid subscription. But everyone can export a file: activities.csv from Strava, a Garmin export, or your own table with date, type and minutes will do.',
  '{d} за 30 дней': '{d} over 30 days',
  '{d} за 30 дней · утром, до кофе': '{d} over 30 days · morning, before coffee',
  'В файле не нашлось тренировок: нужны колонки с датой и длительностью.': 'No workouts found in the file: it needs date and duration columns.',
  'Верхнее': 'Systolic',
  'Нижнее': 'Diastolic',
  'Все записи из файла уже есть.': 'Everything in this file is already here.',
  'Давление': 'Blood pressure',
  'Давление верхнее': 'Systolic pressure',
  'Давление нижнее': 'Diastolic pressure',
  'Дистанция, км': 'Distance, km',
  'Добавлено: {n} {what}': 'Added: {n} {what}',
  'За 30 дней по видам': 'Last 30 days by type',
  'Замеров пока нет': 'No entries yet',
  'Замеры вводятся руками: Apple Health веб-приложению закрыт. Второй замер за день заменяет первый.': 'Entries are typed in by hand: Apple Health is closed to web apps. A second entry on the same day replaces the first.',
  'Из других приложений': 'From other apps',
  'Импорт из CSV': 'Import from CSV',
  'Как прошло': 'How it went',
  'Когда': 'When',
  'Легко': 'Easy',
  'Нормально': 'Normal',
  'Тяжело': 'Hard',
  'На пределе': 'All out',
  'Минут': 'Minutes',
  'Нажмите «+», чтобы отметить тренировку.': 'Tap “+” to log a workout.',
  'Найдено записей: {n}, новых: {fresh}, не разобрано строк: {skipped}. Добавить новые?': 'Found {n} records, {fresh} new, {skipped} rows unreadable. Add the new ones?',
  'Недавние': 'Recent',
  'Новая тренировка': 'New workout',
  'Тренировка': 'Workout',
  'Добавить ещё вид': 'Add another exercise',
  'Из шаблона': 'From template',
  'Название упражнения': 'Exercise name',
  'Название шаблона': 'Template name',
  'Название шаблона:': 'Template name:',
  'Например, «День ног»': 'E.g. “Leg day”',
  'Своё': 'Custom',
  'Сделать из этого набора шаблон': 'Make this set a template',
  'Сохранить шаблон': 'Save template',
  'Удалить шаблон': 'Delete template',
  'Удалить шаблон?': 'Delete this template?',
  'Шаблоны тренировок': 'Workout templates',
  'Шаблонов пока нет.': 'No templates yet.',
  'Отметить тренировку': 'Log a workout',
  'Отметьте первую — и календарь начнёт считать ритм.': 'Log the first one — the calendar will start tracking your rhythm.',
  'Первая тренировка — сегодня?': 'First workout — today?',
  'Пока пусто': 'Nothing yet',
  'Последняя — {when}, {what}': 'Last — {when}, {what}',
  'Предыдущая неделя': 'Previous week',
  'Следующая неделя': 'Next week',
  'Сегодня уже была': 'Already done today',
  'Сегодня — отдых': 'Today — rest',
  'Сегодня — тренировка': 'Today — workout',
  'Тренировок не отмечено.': 'No workouts logged.',
  'Удалить тренировку?': 'Delete this workout?',
  'Цель на неделю': 'Weekly goal',
  'Цель: больше': 'Goal: more',
  'Цель: меньше': 'Goal: less',
  'Что делали, как самочувствие…': 'What you did, how you felt…',
  'дней между': 'days between',
  'дней на неделе': 'days this week',
  'за месяц': 'this month',
  'км': 'km',
  'м': 'm',
  'недель по цели': 'weeks on goal',
  'позавчера': 'the day before yesterday',
  'среднее за неделю {v}': '7-day average {v}',
  'среднее за неделю · последний {when}: {v}': '7-day average · last {when}: {v}',
  'утром, до кофе': 'morning, before coffee',
  'Бег': 'Running',
  'Силовая': 'Strength',
  'Бокс': 'Boxing',
  'Гири': 'Kettlebell',
  ...
  'Другое': 'Other',
  'Вес': 'Weight',
  'Пульс покоя': 'Resting pulse',
  'кг': 'kg',
  'уд/мин': 'bpm',
  'мм рт. ст.': 'mmHg',
  ', ещё не наступил': ', not yet',
  '{done} из {goal} на неделе': '{done} of {goal} this week',
  '{d} к прошлому · {when}': '{d} vs previous · {when}',
  'Замеры вводятся руками: Apple Health веб-приложению закрыт. Второй замер за день заменяет первый. Норм приложение не знает — их сверяйте с бланком лаборатории.': 'Entries are typed in by hand: Apple Health is closed to web apps. A second entry on the same day replaces the first. The app knows no reference ranges — check those against your lab report.',
  'Из анализов': 'From lab tests',
  'Первая тренировка сегодня?': 'First workout today?',
  'Удалить замер за этот день': 'Delete this day\'s entry',
  'Удалить замер за этот день?': 'Delete this day\'s entry?',
  'дней между тренировками': 'days between workouts',
  'недель подряд с целью': 'weeks in a row on goal',
  'тренировок за месяц': 'workouts this month',
  'часов за месяц': 'hours this month',
  'Гемоглобин': 'Hemoglobin',
  'Ферритин': 'Ferritin',
  'г/л': 'g/L',
  'нг/мл': 'ng/mL',
  // «Фокус»: звуки по опыту Focus To-Do (12.09)
  'Белый шум': 'White noise',
  'Будильник': 'Alarm clock',
  'Велозвонок': 'Bicycle bell',
  'Ветер': 'Wind',
  'Ветряные колокольчики': 'Wind chimes',
  'Громкость сигнала': 'Chime volume',
  'Громкость шума': 'Noise volume',
  'Ещё 5 минут': '5 minutes left',
  'Звонок': 'Ring',
  'Звуки': 'Sounds',
  'Конец перерыва': 'End of break',
  'Конец фокуса': 'End of focus',
  'Коричневый шум': 'Brown noise',
  'Костёр': 'Campfire',
  'Круг скоро закончится': 'The round is about to end',
  'Кукушка': 'Cuckoo',
  'Мелодии звучат, пока приложение открыто. В свёрнутом — стандартный сигнал уведомления.': 'Chimes play while the app is open. In the background you get the standard notification sound.',
  'Метроном': 'Metronome',
  'Море': 'Sea',
  'На весь экран': 'Full screen',
  'Нажатие — послушать. В свёрнутом приложении на iPhone звучит стандартный сигнал уведомления.': 'Tap to listen. When the app is in the background on iPhone, the standard notification sound plays.',
  'Пианино': 'Piano',
  'Предупредить за 5 минут': 'Warn 5 minutes before',
  'Птицы': 'Birds',
  ...
  'Таймер': 'Timer',
  'Тиканье': 'Ticking',
  'Уведомление до конца фокуса': 'A notification before focus ends',
  'Фанфары': 'Fanfare',
