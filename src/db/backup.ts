...
/** Пора ли звать сделать копию — точка на вкладке «Главная», «Пора сделать
 *  резервную копию» на карточке настроек и оранжевый цвет строки о копии в
 *  «Состоянии данных». Копии нет или она старше недели — и при этом есть что
 *  сохранять.
 *
